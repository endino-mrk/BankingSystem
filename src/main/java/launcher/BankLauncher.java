...
//        switch (opt) {
//            case "1":
//                a = AccountCreationService.createNewCreditAccount(loggedBank);
//                break;
//            case "2":
//                a = AccountCreationService.createNewSavingsAccount(loggedBank);
//                break;
//            default:
//                System.out.println("Input error: Invalid input. \n");
//        }
//
//        if (a != null) {
////            AccountCreationService.addNewAccount(a);
