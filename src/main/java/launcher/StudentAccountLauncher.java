...
/// // A class primarily used for interacting with the StudentAccount module
...
//        return null;
    ...
    public static void studentAccountInit(){
        StudentAccount account = getLoggedAccount();
     ...
     */
    public static void deposit(StudentAccount account){
    ...
    public static void withdraw(StudentAccount account){
        Field<Double, Double> amount = new Field<>("amount", Double.class, 0.0, new Field.DoubleFieldValidator());
        amount.setFieldValue("Enter amount: ");

        WithdrawService.withdraw(account, amount.getFieldValue());
    }
    public static void transfer(StudentAccount account) {
        Field<Double, Double> amount = new Field<>("amount", Double.class, 0.0, new Field.DoubleFieldValidator());
